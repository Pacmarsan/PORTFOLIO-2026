...
def verify_specter_cover():
    with sync_playwright() as p:
        ...
        # Click "SPECTER"
        page.get_by_text("SPECTER", exact=True).click()
        page.wait_for_timeout(1000)

        # Take screenshot
        page.screenshot(path="verification/specter_cover.png")
        print("Captured verification/specter_cover.png")

        browser.close()

if __name__ == "__main__":
    verify_specter_cover()
