...
def verify_bloodmoon_cover():
    with sync_playwright() as p:
        ...
        # Click "BLOODMOON ZERO"
        page.get_by_text("BLOODMOON ZERO", exact=True).click()
        page.wait_for_timeout(1000)

        # Take screenshot
        page.screenshot(path="verification/bloodmoon_cover.png")
        print("Captured verification/bloodmoon_cover.png")

        browser.close()

if __name__ == "__main__":
    verify_bloodmoon_cover()
